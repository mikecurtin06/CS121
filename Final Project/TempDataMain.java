...
public class TempDataMain {
   ...
   public static void main(String[] args)  {
      ...
      if(dfa!=null) {
        /*TODO: add a try/catch block around the processFile method 
         and the statement that sets dataAcquired to true.  
         The catch block should catch a DataFileProcessingException and
         print it's message to the console.
         */
         dfa.processFile();
         dataAcquired = true;
         ...
         if(dataAcquired) {
            ...
            if(plotType.equalsIgnoreCase("B")){
               ...
               //TODO: implement this else clause so the LineChart is displayed.  
            }
            else 
